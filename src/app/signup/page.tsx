        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 p-4 text-slate-200 overflow-hidden relative">
            ...
            <div className="relative w-full max-w-md rounded-3xl bg-white/5 p-8 shadow-2xl backdrop-blur-xl border border-white/10">
                <div className="mb-10 text-center">
                    <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Calcett<span className="text-emerald-400">ONE</span></h1>
                ...
                <form action={signup} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Es: Zinedine Zidane"
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                        />
                        <p className="mt-2 text-xs text-slate-500">Almeno 6 caratteri passati in spogliatoio.</p>
                    </div>
